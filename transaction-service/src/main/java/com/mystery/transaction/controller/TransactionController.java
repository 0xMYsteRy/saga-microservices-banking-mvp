package com.mystery.transaction.controller;

import com.mystery.common.util.SecurityUtil;
import com.mystery.common.entity.Transaction;
import com.mystery.transaction.service.TransactionService;
...
public class TransactionController {
    ...
    @PreAuthorize("hasRole(T(com.mystery.common.AppConstants).ROLE_BAAS_ADMIN) or hasRole(T(com.mystery.common.AppConstants).ROLE_ACCOUNT_HOLDER)")
    @GetMapping("/{id}")
    ...
    @PreAuthorize("hasRole(T(com.mystery.common.AppConstants).ROLE_ACCOUNT_HOLDER)")
